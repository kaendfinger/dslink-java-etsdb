package org.dsa.iot.etsdb.stats;

import org.dsa.iot.dslink.node.value.Value;
import org.dsa.iot.dslink.node.value.ValueUtils;
import org.dsa.iot.etsdb.stats.rollup.*;
...
public class Interval {
     ...
     */
    public JsonArray getUpdate(Value value, long fullTs) {
        ...
        if (alignedTs == lastValueTimeTrunc) {
            ...
            if (rollup == null) {
                array = getJsonUpdate(lastValueTimeTrunc, lastValue);
            } else {
                array = getJsonUpdate(lastValueTimeTrunc, rollup.getValue());
            }
            lastValue = null;
        }
    ...
    private JsonArray getJsonUpdate(long ts, Value value) {
